...
export const CreateGroupModalContent = ({ onClose, onConfirm: createGroup, toastObject }: ModalInnerComponentType) => {
  ...
  const [groupWalletAddressData, setGroupWalletAddress] = React.useState<string>('');
  const [groupWalletSecretKeyData, setGroupSecretKey] = React.useState<string>('');
      ...
      <ModalContainer createGroupState={createGroupState}>
        ...
        {createGroupState == 1 && (
          <GroupDetailsContent
            ...
            groupWalletAddress={groupWalletAddressData}
            groupWalletSeqretKey={groupWalletSecretKeyData}
